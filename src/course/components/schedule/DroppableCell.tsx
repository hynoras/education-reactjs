...
const DroppableCell: React.FC<DroppableCellProps> = ({ day, time, placedClass, rowSpan }) => {
  ...
  const cellStyle: React.CSSProperties = {
    ...
    textAlign: "center",
    verticalAlign: "top",
    backgroundColor: isOver ? "#fee2e2" : "transparent",
    position: "relative"
  }

  return (
    <td rowSpan={rowSpan} ref={setNodeRef} style={cellStyle}>
      {placedClass && (
        <div
          style={{
            position: "absolute",
